...
description: "An access token in Windows is a data structure used by the operating system to represent the security context of a process or thread. It contains..."
---
...
* [Handle Enumeration](../malware/object-enumeration/handle.md)
