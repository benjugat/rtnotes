...
description: "Red Teamers and penetration testers use Cobalt Strike to demonstrate the risk of a breach and evaluate mature security programs."
---
...
![](../images/cobaltstrike-listener.png)
...
![](../images/cobaltstrike-listener-tcp-chain.png)
...
![](../images/cobaltstrike-listener-p2p.png)
...
![](../images/cobaltstrike-staged.png)

## Stageless Payloads

Go to `Attacks -> Packages -> Windows Executable (S)`:

![](../images/cobaltstrike-stageless.png)
...
![](../images/cobaltstrike-interact.png)
...
![](../images/cobaltstrike-hostfile.png)
